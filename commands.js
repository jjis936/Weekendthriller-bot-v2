...
// 10 FIRE BLACK MARKET COMMANDS
slashCommands.push({
    data: new SlashCommandBuilder().setName("premiumtiers").setDescription("💎 View all premium tier levels"),
    execute: async (interaction) => {
        const embeds = [];
        const tiers = [
            { name: "🥉 BRONZE", desc: "Entry Level", perks: "✅ Standard support\n✅ Access all services\n✅ Community member", discount: "No discount" },
            { name: "🥈 SILVER", desc: "Growing Trust", perks: "✅ Priority support (10min)\n✅ 5% off all services\n✅ Early access promos", discount: "5% off" },
            { name: "🥇 GOLD", desc: "Regular Customer", perks: "✅ VIP support (5min)\n✅ 10% off all services\n✅ Monthly bonuses", discount: "10% off" },
            { name: "💜 PLATINUM", desc: "Elite Status", perks: "✅ 24/7 dedicated staff\n✅ 15% off all services\n✅ Custom packages", discount: "15% off" },
            { name: "👑 APEX", desc: "Legendary", perks: "✅ Private seller network\n✅ 20% off everything\n✅ Lifetime guarantee", discount: "20% off" },
            { name: "🔓 BLACK MARKET", desc: "Underground", perks: "✅ No limits policy\n✅ Custom pricing\n✅ Exclusive access", discount: "CUSTOM" }
        ];
        for (const tier of tiers) {
            embeds.push(new EmbedBuilder().setColor(tier.name.includes("🔓") ? "#FF00FF" : "#9D00FF").setTitle(`${tier.name} TIER`).setDescription(`Rank: ${tier.desc}`).addField("🎁 PERKS", tier.perks, false).addField("💰 DISCOUNT", tier.discount, true).setFooter({ text: "TIER UP BY PURCHASING" }).setTimestamp());
        }
...
slashCommands.push({
    data: new SlashCommandBuilder().setName("services").setDescription("🔓 View all services in detail"),
    execute: async (interaction) => {
        const embeds = [
            new EmbedBuilder().setColor("#9D00FF").setTitle("🚀 WZ RANKED BOOST").setDescription("Professional Warzone carry").addField("✨ FEATURES", "✅ Expert handlers\n✅ Instant return\n✅ 24/7 support\n✅ Money-back guarantee", false).addField("💰 PRICE", "$15-$65", true).setFooter({ text: "INSTANT - 24HR GUARANTEED" }).setTimestamp(),
            new EmbedBuilder().setColor("#FF00FF").setTitle("🎮 MP RANKED BOOST").setDescription("Multiplayer ranking service").addField("✨ FEATURES", "✅ All weapons\n✅ Skill-based\n✅ Fast completion\n✅ Zero detection", false).addField("💰 PRICE", "$10-$50", true).setFooter({ text: "INSTANT - 24HR GUARANTEED" }).setTimestamp(),
            new EmbedBuilder().setColor("#9D00FF").setTitle("🎨 CAMO UNLOCKS").setDescription("Instant weapon cosmetics").addField("✨ FEATURES", "✅ Any combo\n✅ Instant access\n✅ All tiers\n✅ Future updates", false).addField("💰 PRICE", "$5-$75", true).setFooter({ text: "INSTANT DELIVERY" }).setTimestamp(),
            new EmbedBuilder().setColor("#FF00FF").setTitle("📱 NUMBER RENTAL").setDescription("Global SMS verification").addField("✨ FEATURES", "✅ Global coverage\n✅ Instant activation\n✅ Privacy assured\n✅ Reusable", false).addField("💰 PRICE", "$2-$75", true).setFooter({ text: "INSTANT DELIVERY" }).setTimestamp(),
            new EmbedBuilder().setColor("#9D00FF").setTitle("👾 OPERATOR UNLOCKS").setDescription("Exclusive operator skins").addField("✨ FEATURES", "✅ All operators\n✅ Instant access\n✅ Exclusive skins\n✅ Account safe", false).addField("💰 PRICE", "$8-$80", true).setFooter({ text: "INSTANT DELIVERY" }).setTimestamp()
        ];
        await interaction.reply({ embeds });
    }
});
...
slashCommands.push({
    data: new SlashCommandBuilder().setName("payment").setDescription("💳 Payment information & CashApp"),
    execute: async (interaction) => {
        const embed = new EmbedBuilder().setColor("#9D00FF").setTitle("💳 SECURE PAYMENT GATEWAY 💳").addField("💰 PAYMENT METHOD", "**CashApp Only**\n`$EvanJoyner8`", true).addField("⚡ SPEED", "Instant confirmation\nService starts in 5min", true).addField("📋 PROCESS", "1️⃣ Open CashApp\n2️⃣ Send to `$EvanJoyner8`\n3️⃣ Screenshot confirmation\n4️⃣ Service starts immediately\n5️⃣ Completion in 24h or less", false).setFooter({ text: "WEEKENDTHRILLER VERIFIED SELLER • $EvanJoyner8" }).setTimestamp();
        const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setLabel("💰 Send Payment (CashApp)").setStyle(ButtonStyle.Link).setURL("https://cash.app/$EvanJoyner8"), new ButtonBuilder().setCustomId("confirm_payment").setLabel("✅ Confirm Payment Sent").setStyle(ButtonStyle.Success));
        await interaction.reply({ embeds: [embed], components: [row], ephemeral: true });
    }
});

slashCommands.push({
    data: new SlashCommandBuilder().setName("pricing").setDescription("💰 Complete pricing breakdown"),
    execute: async (interaction) => {
        const embed = new EmbedBuilder().setColor("#FF00FF").setTitle("💰 COMPLETE PRICING 💰").addField("🚀 WZ BOOST", "0-10: $15 | 10-25: $25 | 25-50: $40 | 50+: $65", false).addField("🎮 MP BOOST", "0-5: $10 | 5-10: $18 | 10-20: $30 | 20+: $50", false).addField("🎨 CAMOS", "Single: $5 | 5 wpn: $20 | All: $50 | All+Gold: $75", false).addField("👾 OPERATORS", "Single: $8 | 5 bundle: $30 | All: $80", false).addField("📱 NUMBERS", "1d: $2 | 7d: $10 | 30d: $30 | 90d: $75", false).addField("💎 VIP", "1mo: $25 | 3mo: $60 | 12mo: $180", false).addField("🎁 TIER DISCOUNTS", "BRONZE: 0% | SILVER: 5% | GOLD: 10% | PLATINUM: 15% | APEX: 20%", false).setFooter({ text: "PAYMENT: CashApp $EvanJoyner8" }).setTimestamp();
        await interaction.reply({ embeds: [embed] });
    }
});

slashCommands.push({
    data: new SlashCommandBuilder().setName("bundles").setDescription("🎁 Premium bundle deals"),
    execute: async (interaction) => {
        const embeds = [
            new EmbedBuilder().setColor("#9D00FF").setTitle("🎁 STARTER BUNDLE").addField("📦 INCLUDES", "✅ 20 WZ Wins\n✅ 5 Camos\n✅ 1 Number (7d)\n✅ Basic support", false).addField("💵 PRICE", "$50 (Save $15)", true).setFooter({ text: "SAVE 23%" }).setTimestamp(),
            new EmbedBuilder().setColor("#FF00FF").setTitle("💜 VIP BUNDLE").addField("📦 INCLUDES", "✅ 50 WZ Wins\n✅ All Camos\n✅ 5 Operators\n✅ 1 Month VIP\n✅ Priority support", false).addField("💵 PRICE", "$120 (Save $35)", true).setFooter({ text: "MOST POPULAR" }).setTimestamp(),
            new EmbedBuilder().setColor("#9D00FF").setTitle("👑 APEX BUNDLE").addField("📦 INCLUDES", "✅ 100 WZ Wins\n✅ All Camos\n✅ All Operators\n✅ 1 Year VIP\n✅ Dedicated handler\n✅ Free monthly", false).addField("💵 PRICE", "$250 (Save $70)", true).setFooter({ text: "ELITE PACKAGE" }).setTimestamp(),
            new EmbedBuilder().setColor("#FF00FF").setTitle("🔓 BLACK MARKET").addField("📦 INCLUDES", "✅ Everything x2\n✅ Private network\n✅ Custom packages\n✅ Lifetime 20% off\n✅ Underground perks", false).addField("💵 PRICE", "CUSTOM QUOTE", true).setFooter({ text: "INVITATION ONLY" }).setTimestamp()
        ];
        await interaction.reply({ embeds });
    }
});
...
slashCommands.push({
    data: new SlashCommandBuilder().setName("blackmarket").setDescription("🔓 Enter the black market vault"),
    execute: async (interaction) => {
        const embed = new EmbedBuilder().setColor("#9D00FF").setTitle("💀 WEEKENDTHRILLER BLACK MARKET 💀").setDescription("```\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nWELCOME TO THE UNDERGROUND VAULT\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n```\n\n🔓 EXCLUSIVE SERVICES | ⚡ INSTANT DELIVERY | 🎯 100% DISCRETION\n💰 Payment: CashApp `$EvanJoyner8`").setFooter({ text: "AUTHENTICATION REQUIRED" }).setTimestamp();
        const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId("view_services").setLabel("🛍️ View Services").setStyle(ButtonStyle.Primary), new ButtonBuilder().setLabel("💳 Send Payment").setStyle(ButtonStyle.Link).setURL("https://cash.app/$EvanJoyner8"));
        await interaction.reply({ embeds: [embed], components: [row], ephemeral: false });
    }
});

slashCommands.push({
    data: new SlashCommandBuilder().setName("security").setDescription("🔒 Security & account protection"),
    execute: async (interaction) => {
        const embed = new EmbedBuilder().setColor("#9D00FF").setTitle("🔒 SECURITY & PROTECTION 🔒").addField("🛡️ ACCOUNT", "✅ Encryption\n✅ VPN routing\n✅ Isolated handling\n✅ 2FA support\n✅ Zero compromises", false).addField("📊 DATA", "✅ Never shared\n✅ Auto-deleted 30d\n✅ GDPR compliant\n✅ No logs\n✅ Encrypted only", false).addField("📈 TRACK RECORD", "✅ 2,800+ customers\n✅ Zero bans (30d)\n✅ 99.8% safety\n✅ 500+ reviews\n✅ 5+ years", false).setFooter({ text: "YOUR SAFETY IS OUR PRIORITY" }).setTimestamp();
        await interaction.reply({ embeds: [embed] });
    }
});

slashCommands.push({
    data: new SlashCommandBuilder().setName("testimonials").setDescription("⭐ Customer reviews"),
    execute: async (interaction) => {
        const embed = new EmbedBuilder().setColor("#FF00FF").setTitle("⭐ CUSTOMER TESTIMONIALS ⭐").setDescription("```\n500+ 5-STAR REVIEWS | 98.7% SATISFACTION\n```").addField("⭐ @Shadow", "\"50 wins in 2 days. Insane service. Worth every dollar.\"", false).addField("⭐ @Ghost", "\"Fast, reliable, professional. 10/10 recommend.\"", false).addField("⭐ @Apex", "\"Support team is incredible. Fixed issue in 5min.\"", false).addField("⭐ @Titan", "\"6 months, 25 purchases, perfect every time.\"", false).addField("📊 STATS", "✅ 500+ verified reviews\n✅ 2,800+ customers\n✅ 98.7% satisfaction\n✅ Zero complaints (30d)", false).setFooter({ text: "REAL REVIEWS FROM REAL CUSTOMERS" }).setTimestamp();
        await interaction.reply({ embeds: [embed] });
    }
});

slashCommands.push({
    data: new SlashCommandBuilder().setName("faq").setDescription("❓ Frequently asked questions"),
    execute: async (interaction) => {
        const embed = new EmbedBuilder().setColor("#9D00FF").setTitle("❓ FREQUENTLY ASKED QUESTIONS ❓").addField("Q: Is my account safe?", "✅ YES. Zero bans. Industry security. VPN routing.", false).addField("Q: How fast?", "✅ INSTANT to 24h. Most complete within hours.", false).addField("Q: Money-back?", "✅ YES. 100% within 48h. No questions.", false).addField("Q: Will I get banned?", "✅ NO. Zero bans reported. Expert handling.", false).addField("Q: What if issue?", "✅ We handle it. Full recovery included. 24/7 support.", false).addField("Q: How to pay?", "✅ CashApp `$EvanJoyner8`. Instant. Secure.", false).setFooter({ text: "MORE QUESTIONS? OPEN A TICKET" }).setTimestamp();
        await interaction.reply({ embeds: [embed] });
    }
});

slashCommands.push({
    data: new SlashCommandBuilder().setName("vipperks").setDescription("💎 Exclusive VIP benefits"),
    execute: async (interaction) => {
        const embeds = [
            new EmbedBuilder().setColor("#FF00FF").setTitle("💜 SILVER VIP").addField("🎁 BENEFITS", "✅ 5% off\n✅ Priority support\n✅ VIP badge\n✅ Early access\n✅ Monthly gift", false).setFooter({ text: "6-15 PURCHASES" }).setTimestamp(),
            new EmbedBuilder().setColor("#FF00FF").setTitle("🥇 GOLD VIP").addField("🎁 BENEFITS", "✅ 10% off\n✅ VIP support (5min)\n✅ Custom packages\n✅ Free services\n✅ Priority queue", false).setFooter({ text: "16-30 PURCHASES" }).setTimestamp(),
            new EmbedBuilder().setColor("#FF00FF").setTitle("💜 PLATINUM VIP").addField("🎁 BENEFITS", "✅ 15% off\n✅ 24/7 handler\n✅ Custom packages\n✅ Monthly $100 free\n✅ Private channel", false).setFooter({ text: "31+ PURCHASES" }).setTimestamp(),
            new EmbedBuilder().setColor("#9D00FF").setTitle("👑 APEX LEGENDARY").addField("🎁 BENEFITS", "✅ 20% off ALL\n✅ Private network\n✅ No limits\n✅ Weekly free\n✅ Lifetime recovery", false).setFooter({ text: "100+ PURCHASES" }).setTimestamp()
        ];
        await interaction.reply({ embeds });
    }
});
