...
const slashCommands = [
    ...
    { data: new SlashCommandBuilder().setName("premiumtiers").setDescription("💎 View all premium tier levels"), execute: async (interaction) => { const embeds = []; const tiers = [{ name: "🥉 BRONZE", desc: "Entry Level", perks: "✅ Standard support\n✅ Access all services", discount: "No discount" }, { name: "🥈 SILVER", desc: "Growing Trust", perks: "✅ Priority support\n✅ 5% off all services", discount: "5% off" }, { name: "🥇 GOLD", desc: "Regular Customer", perks: "✅ VIP support\n✅ 10% off all services", discount: "10% off" }, { name: "💜 PLATINUM", desc: "Elite Status", perks: "✅ 24/7 dedicated staff\n✅ 15% off all services", discount: "15% off" }, { name: "👑 APEX", desc: "Legendary", perks: "✅ Private network\n✅ 20% off everything", discount: "20% off" }, { name: "🔓 BLACK MARKET", desc: "Underground", perks: "✅ No limits\n✅ Custom pricing", discount: "CUSTOM" }]; for (const tier of tiers) { embeds.push(new EmbedBuilder().setColor(tier.name.includes("🔓") ? "#FF00FF" : "#9D00FF").setTitle(`${tier.name} TIER`).setDescription(`Rank: ${tier.desc}`).addField("🎁 PERKS", tier.perks, false).addField("💰 DISCOUNT", tier.discount, true).setFooter({ text: "TIER UP BY PURCHASING" }).setTimestamp()); } await interaction.reply({ embeds }); } },
    { data: new SlashCommandBuilder().setName("services").setDescription("🔓 View all services in detail"), execute: async (interaction) => { const embeds = [new EmbedBuilder().setColor("#9D00FF").setTitle("🚀 WZ RANKED BOOST").addField("✨ FEATURES", "✅ Expert handlers\n✅ 24/7 support\n✅ Money-back guarantee", false).addField("💰 PRICE", "$15-$65", true).setFooter({ text: "INSTANT - 24HR" }).setTimestamp(), new EmbedBuilder().setColor("#FF00FF").setTitle("🎮 MP RANKED BOOST").addField("✨ FEATURES", "✅ All weapons\n✅ Skill-based\n✅ Fast completion", false).addField("💰 PRICE", "$10-$50", true).setFooter({ text: "INSTANT - 24HR" }).setTimestamp(), new EmbedBuilder().setColor("#9D00FF").setTitle("🎨 CAMO UNLOCKS").addField("✨ FEATURES", "✅ Any combo\n✅ Instant access\n✅ All tiers", false).addField("💰 PRICE", "$5-$75", true).setFooter({ text: "INSTANT" }).setTimestamp(), new EmbedBuilder().setColor("#FF00FF").setTitle("📱 NUMBER RENTAL").addField("✨ FEATURES", "✅ Global coverage\n✅ Instant activation\n✅ Reusable", false).addField("💰 PRICE", "$2-$75", true).setFooter({ text: "INSTANT" }).setTimestamp(), new EmbedBuilder().setColor("#9D00FF").setTitle("👾 OPERATORS").addField("✨ FEATURES", "✅ All operators\n✅ Instant access\n✅ Account safe", false).addField("💰 PRICE", "$8-$80", true).setFooter({ text: "INSTANT" }).setTimestamp()]; await interaction.reply({ embeds }); } },
    { data: new SlashCommandBuilder().setName("payment").setDescription("💳 Payment info & CashApp"), execute: async (interaction) => { const embed = new EmbedBuilder().setColor("#9D00FF").setTitle("💳 PAYMENT 💳").addField("💰 METHOD", "`$EvanJoyner8`", true).addField("⚡ SPEED", "Instant", true).addField("📋 PROCESS", "1️⃣ Send to `$EvanJoyner8`\n2️⃣ Screenshot\n3️⃣ Service starts\n4️⃣ 24h or less", false).setFooter({ text: "VERIFIED SELLER" }).setTimestamp(); const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setLabel("💰 Send Payment").setStyle(ButtonStyle.Link).setURL("https://cash.app/$EvanJoyner8")); await interaction.reply({ embeds: [embed], components: [row], ephemeral: true }); } },
    { data: new SlashCommandBuilder().setName("pricing").setDescription("💰 Complete pricing"), execute: async (interaction) => { const embed = new EmbedBuilder().setColor("#FF00FF").setTitle("💰 PRICING 💰").addField("🚀 WZ", "0-10: $15 | 10-25: $25 | 25-50: $40 | 50+: $65", false).addField("🎮 MP", "0-5: $10 | 5-10: $18 | 10-20: $30 | 20+: $50", false).addField("🎨 CAMOS", "Single: $5 | 5: $20 | All: $50 | Gold: $75", false).addField("👾 OPS", "Single: $8 | 5: $30 | All: $80", false).addField("📱 #", "1d: $2 | 7d: $10 | 30d: $30 | 90d: $75", false).addField("💎 VIP", "1m: $25 | 3m: $60 | 12m: $180", false).setFooter({ text: "CashApp $EvanJoyner8" }).setTimestamp(); await interaction.reply({ embeds: [embed] }); } },
    { data: new SlashCommandBuilder().setName("bundles").setDescription("🎁 Premium bundles"), execute: async (interaction) => { const embeds = [new EmbedBuilder().setColor("#9D00FF").setTitle("🎁 STARTER").addField("📦", "✅ 20 WZ\n✅ 5 Camos\n✅ 1 Number", false).addField("💵", "$50 (Save $15)", true).setTimestamp(), new EmbedBuilder().setColor("#FF00FF").setTitle("💜 VIP").addField("📦", "✅ 50 WZ\n✅ All Camos\n✅ 5 Ops\n✅ 1mo VIP", false).addField("💵", "$120 (Save $35)", true).setTimestamp(), new EmbedBuilder().setColor("#9D00FF").setTitle("👑 APEX").addField("📦", "✅ 100 WZ\n✅ All Camos\n✅ All Ops\n✅ 1yr VIP", false).addField("💵", "$250 (Save $70)", true).setTimestamp(), new EmbedBuilder().setColor("#FF00FF").setTitle("🔓 MARKET").addField("📦", "✅ Everything x2\n✅ Private network\n✅ Custom", false).addField("💵", "CUSTOM", true).setTimestamp()]; await interaction.reply({ embeds }); } },
    { data: new SlashCommandBuilder().setName("blackmarket").setDescription("🔓 Black market vault"), execute: async (interaction) => { const embed = new EmbedBuilder().setColor("#9D00FF").setTitle("💀 BLACK MARKET 💀").setDescription("🔓 EXCLUSIVE SERVICES | ⚡ INSTANT | 🎯 DISCRETE\n💰 CashApp: `$EvanJoyner8`").setFooter({ text: "VAULT UNLOCKED" }).setTimestamp(); const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setLabel("💳 Send Payment").setStyle(ButtonStyle.Link).setURL("https://cash.app/$EvanJoyner8")); await interaction.reply({ embeds: [embed], components: [row] }); } },
    { data: new SlashCommandBuilder().setName("security").setDescription("🔒 Security & protection"), execute: async (interaction) => { const embed = new EmbedBuilder().setColor("#9D00FF").setTitle("🔒 SECURITY 🔒").addField("🛡️", "✅ Encryption\n✅ VPN routing\n✅ 2FA support\n✅ Zero compromise", false).addField("📊", "✅ Never shared\n✅ Auto-delete 30d\n✅ GDPR compliant\n✅ Zero bans (30d)", false).setFooter({ text: "YOUR SAFETY FIRST" }).setTimestamp(); await interaction.reply({ embeds: [embed] }); } },
    { data: new SlashCommandBuilder().setName("testimonials").setDescription("⭐ Customer reviews"), execute: async (interaction) => { const embed = new EmbedBuilder().setColor("#FF00FF").setTitle("⭐ TESTIMONIALS ⭐").setDescription("500+ 5-STAR | 98.7% SATISFACTION").addField("@Shadow", "\"50 wins in 2 days. Insane!\"", false).addField("@Ghost", "\"Fast, reliable, professional.\"", false).addField("@Apex", "\"Support fixed issue in 5min.\"", false).addField("📊", "✅ 500+ reviews\n✅ 2,800+ customers\n✅ 98.7% satisfaction", false).setFooter({ text: "REAL REVIEWS" }).setTimestamp(); await interaction.reply({ embeds: [embed] }); } },
    { data: new SlashCommandBuilder().setName("faq").setDescription("❓ Frequently asked questions"), execute: async (interaction) => { const embed = new EmbedBuilder().setColor("#9D00FF").setTitle("❓ FAQ ❓").addField("Safe?", "✅ YES. Zero bans. Industry security.", false).addField("Fast?", "✅ INSTANT to 24h. Most within hours.", false).addField("Refund?", "✅ YES. 100% within 48h.", false).addField("Banned?", "✅ NO. Zero bans reported.", false).addField("Issue?", "✅ We handle it. 24/7 support.", false).addField("Pay?", "✅ CashApp `$EvanJoyner8`. Instant.", false).setFooter({ text: "MORE? OPEN TICKET" }).setTimestamp(); await interaction.reply({ embeds: [embed] }); } },
    { data: new SlashCommandBuilder().setName("vipperks").setDescription("💎 VIP benefits"), execute: async (interaction) => { const embeds = [new EmbedBuilder().setColor("#FF00FF").setTitle("💜 SILVER VIP").addField("🎁", "✅ 5% off\n✅ Priority support\n✅ Early access\n✅ Monthly gift", false).setTimestamp(), new EmbedBuilder().setColor("#FF00FF").setTitle("🥇 GOLD VIP").addField("🎁", "✅ 10% off\n✅ VIP support (5min)\n✅ Free services\n✅ Priority queue", false).setTimestamp(), new EmbedBuilder().setColor("#FF00FF").setTitle("💜 PLATINUM VIP").addField("🎁", "✅ 15% off\n✅ 24/7 handler\n✅ Monthly $100 free\n✅ Private channel", false).setTimestamp(), new EmbedBuilder().setColor("#9D00FF").setTitle("👑 APEX").addField("🎁", "✅ 20% off ALL\n✅ Private network\n✅ Weekly free\n✅ Lifetime recovery", false).setTimestamp()]; await interaction.reply({ embeds }); } },
