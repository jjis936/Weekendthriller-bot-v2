...
const BLACK_MARKET = {
    createPremiumEmbed: (title, description) => {
        return new EmbedBuilder()
            ...
            .setFooter({ text: "⚡ WEEKENDTHRILLER BLACK MARKET ⚡" })
            .setTimestamp();
    },
    ...
    createExclusiveEmbed: (title) => {
        return new EmbedBuilder()
            .setColor("#FF00FF")
            .setTitle(`💀 ${title} 💀`)
            .setFooter({ text: "EXCLUSIVE | VIP ACCESS" })
            .setTimestamp();
    }
};
    ...
    execute: async (interaction) => {
        ...
        embeds.push(
            new EmbedBuilder()
                ...
                .setFooter({ text: "AUTHENTICATION REQUIRED" })
                .setTimestamp()
        );
        ...
        embeds.push(
            new EmbedBuilder()
                ...
                .setFooter({ text: "ALL SERVICES BACKED BY OUR GUARANTEE" })
                .setTimestamp()
        );
        ...
        embeds.push(
            new EmbedBuilder()
                ...
                .setFooter({ text: "WEEKENDTHRILLER SERVICES" })
                .setTimestamp()
        );
