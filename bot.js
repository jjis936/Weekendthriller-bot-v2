    ...
    try{
        ...
        if(interaction.isButton()){
            ...
            if(!handler){
                ...
                else if(interaction.customId.startsWith("duel_accept_")) handler = allButtonHandlers.duel_accept;
                else if(interaction.customId.startsWith("duel_decline_")) handler = allButtonHandlers.duel_decline;
